...
Build and install CADMesh against the Geant4 10.7.4 install produced by this repo.

Options:
  --base-dir PATH         Directory containing the Geant4 install. Default: ${SCRIPT_DIR}/geant4
...
# Generated by installation_script_linuxOnly_CADmesh.bash
...
main() {
    ...
    write_cadmesh_environment
    update_shell_rc
    log "Done. Run 'source ~/.bashrc' or open a new terminal to load CADMesh."
}
